            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-4">
                    <div>
                        ...
                        <p className="text-slate-400">Catálogo de cursos premium. Selecciona un curso para comenzar.</p>
                    </div>

                    <div className="flex items-center gap-4">
                        <Link
                            href="/admin/login"
                            className="text-sm font-medium text-slate-400 hover:text-[var(--color-primary)] transition-colors"
                        >
                            Portal Profesor
                        </Link>
                    </div>
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                {course.hasAccess ? (
                                    ...
                                    <Link
                                        ...
                                        className="mt-auto w-full flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold py-3 px-4 rounded-xl border border-slate-700 transition-all duration-300"
                                    >
                                        <Lock size={18} />
                                        Desbloquear Curso
                                    </Link>
