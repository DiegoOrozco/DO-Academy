                            ...
                            <div className="mt-6 pt-4 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                                <div className="flex items-center gap-2 text-amber-400/70">
                                    ...
                                    <p className="text-[10px] font-medium uppercase tracking-wider">
                                        Puedes modificar tu entrega antes de la fecha límite.
                                    </p>
                                </div>
                                <button
                                    onClick={() => {
                                        if (confirm("¿Deseas modificar tu entrega? Al subir un nuevo archivo, la versión anterior y su calificación (si existe) se borrarán permanentemente del sistema.")) {
                                            setSubmission(null);
                                        }
                                    }}
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 text-white rounded-xl border border-white/10 transition-all text-xs font-bold group"
                                >
                                    <Upload size={14} className="text-[var(--color-primary)] group-hover:scale-110 transition-transform" />
                                    Modificar Entrega
                                </button>
                            </div>
                        )}
